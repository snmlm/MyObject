...
public class FileIconAndType {
    public static final String TYPE_ALL = "all";
    public static final String TYPE_TXT = "txt";
    public static final String TYPE_VIDEO = "video";
    public static final String TYPE_AUDIO = "audio";
    public static final String TYPE_IMAGE = "iamge";
    public static final String TYPE_ZIP = "zip";
    public static final String TYPE_APK = "apk";



    public static String[] getIconAndType(File file){
        String[] iconAndType = new String[2];
        String name = file.getName();
        String suffix = name.substring(name.lastIndexOf(".") + 1, name.length());
        for (int i = 0; i < ICON_TYPE_Table.length; i++) {
            if(ICON_TYPE_Table[i][0].equals(suffix)){
                iconAndType[0] = ICON_TYPE_Table[i][1];
                iconAndType[1] = ICON_TYPE_Table[i][2];
                break;
            }
        }
        return iconAndType;
